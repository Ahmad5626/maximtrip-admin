...
const CreateDestinations = () => {
  ...
  const handleEditClick = (destination) => {
    ...
    setEditFormData({
      ...
      shotDescription: destination.shotDescription || "",
      description: destination.description || "",
      image: destination.image || "",
      status: destination.status || "Active",
      language: destination.language || "en",
    ...
    setEditDescriptionContent(destination.description || "")
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${baseApi}/v1/api/update-destination/${editingDestination._id}`, {
        method: "PUT",
        headers: {
  ...
  const handleTitleChange = (e) => {
    ...
    handleChangeCreateDestinations(e)
      ...
      <section className="my-4">
        ...
        <div className="customContainer bg-white p-5 rounded-lg mx-auto shadow-sm">
          <div className="flex items-center justify-between gap-2 border-b pb-3">
            <h2 className="flex items-center gap-2 text-2xl font-semibold border-neutral-200">Create Destinations</h2>
          </div>

          <form className="space-y-4 my-4" onSubmit={handleSubmitCreateDestinations}>
            {/* Title and Slug Row */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  name="title"
                  value={createDestinationsFormData.title}
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  name="slug"
                  value={createDestinationsFormData.slug}
                  onChange={handleChangeCreateDestinations}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <select
                  className="border rounded-lg px-3 py-2 text-sm w-full outline-none border-gray-200 bg-gray-100"
                  name="status"
                  value={createDestinationsFormData.status}
                  onChange={handleChangeCreateDestinations}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  value={createDestinationsFormData.shotDescription}
                  onChange={handleChangeCreateDestinations}
                />
              </div>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  name="metaTitle"
                  value={createDestinationsFormData.metaTitle}
                  onChange={handleChangeCreateDestinations}
                />
              </div>
            </div>
            ...
            <div className="w-full flex flex-col gap-2">
              <label className="font-semibold text-xs text-gray-500">Description *</label>
              <TiptapEditor
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  name="metaKeyword"
                  value={createDestinationsFormData.metaKeyword}
                  onChange={handleChangeCreateDestinations}
                />
              </div>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  name="updatedBy"
                  value={createDestinationsFormData.updatedBy}
                  onChange={handleChangeCreateDestinations}
                />
              </div>
            </div>
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <textarea
                ...
                value={createDestinationsFormData.metaDescription}
                onChange={handleChangeCreateDestinations}
                rows={3}
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                id="featured"
                name="featured"
                checked={createDestinationsFormData.featured}
                onChange={handleChangeCreateDestinations}
                className="w-4 h-4 text-[#ce3c3d] border-gray-300 rounded focus:ring-[#ce3c3d]"
              />
              <label htmlFor="featured" className="font-semibold text-xs text-gray-500">
                Mark as Featured
              </label>
            </div>
        ...
        {/* Destinations History Table */}
        <div className="customContainer mt-10">
          <Card className="overflow-hidden w-full">
            <CardHeader>
              <CardTitle>Destinations History</CardTitle>
            </CardHeader>
              ...
              <div className="rounded-md border">
                ...
                {destinationsData.length > 0 ? (
                  destinationsData.map((destination) => (
                    <div key={destination._id} className="grid grid-cols-6 gap-4 p-4 border-t items-center">
                      <div className="text-sm font-medium truncate">{destination.title}</div>
                      <div>
                        <span
                      ...
                      <div className="text-sm text-gray-600 truncate">{destination.shotDescription}</div>
                      <div className="text-sm text-gray-600 max-h-20 overflow-hidden">
                        <div
                          className="prose prose-sm max-w-none"
                          dangerouslySetInnerHTML={{
                            __html: destination.description?.substring(0, 100) + "...",
                          }}
                        />
                      </div>
                      ...
                      <div className="flex justify-center gap-2">
                        ...
                        <button
                          ...
                          onClick={() => handleDeleteDestinations(destination._id)}
                        >
                  ...
                  <div className="p-8 text-center text-muted-foreground">
                    ...
                    <div className="text-sm">Create your first destination above</div>
                  </div>
                )}
              </div>
            </CardContent>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-gray-700 mb-3">Destination Image</label>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-4 h-4 text-[#ce3c3d] border-gray-300 rounded focus:ring-[#ce3c3d]"
                  />
                  <label htmlFor="editFeatured" className="font-semibold text-xs text-gray-500">
                    Mark as Featured
                  </label>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  >
                    ...
                    {uploadingImage ? "Uploading..." : "Update Destination"}
                  </button>
                  <button
                    type="button"
