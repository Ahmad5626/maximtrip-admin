...
const Class10OptionalSubjects = () => {
  return (
    <div>
    <Details courseName="Class 10 Optional Subjects" courseDetails="  Take your expertise in [subject] to the next level with our
...
export default Class10OptionalSubjects