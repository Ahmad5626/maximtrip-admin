...
const CreateBlogs = () => {
  const { createBlogFormData, handleSubmitCreateBlog, handleChangeCreateBlog, blogData, handleDeleteBlog,uploadingHero } = useAuth()
    ...
    <div>
      <section className="my-4">
        ...
        <div className="customContainer bg-white p-5 rounded-lg mx-auto shadow-sm">
          ...
          <form className="space-y-3 my-4 flex flex-wrap justify-between items-start" onSubmit={handleSubmitCreateBlog}>
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <TiptapEditor
                content={createBlogFormData.description || ""}
          ...
          <Card className="overflow-hidden w-full">
            ...
            <CardContent className="overflow-x-auto">
              <div className="rounded-md border">
                ...
                {blogData.length > 0 ? (
                  blogData.map((blog) => (
                    <div key={blog._id} className="grid grid-cols-5 gap-4 p-4 border-t items-center">
