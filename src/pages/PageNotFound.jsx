        ...
        <>
            <section className="flex items-center h-[100dvh] sm:p-16 bg-gray-900 text-gray-100">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
                    ...
                    <Link rel="noopener noreferrer" to="/login" className="px-6 py-3 font-semibold rounded bg-blueClr text-white"><i className="fa-solid fa-home mr-2"></i>Back to homepage</Link>
                </div>
            </section>
        </>
    )
