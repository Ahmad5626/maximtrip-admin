...
console.log(emailValue);
    ...
    return (
        <>
            <main className="h-[100dvh] flex items-center justify-center bg-[url('/img/login-cover.png')]  bg-center px-4 sm:px-6 lg:px-8">
                <Toaster position="top-center" />
                <div className="w-[320px] min-h-96 px-8 py-6 text-left bg-[#ffffff] border border-gray-700 bg-opacity-100 backdrop-blur-lg rounded-xl shadow-lg">
                    <form onSubmit={handleloginDashboard}>
                        <div className="flex flex-col h-full select-none">
                            <div className="mb-5 flex justify-center">
                                <img src="/img/maximtrip-logo.png" className="w-[120px]" style={{ fllter: "brightness(10)" }} />
                            </div>
                        ...
                        <div>
                            <button type="submit" className="py-2 my-4 text-sm bg-gradient-to-r from-[#000000] to-[#fe2690] focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 flex justify-center text-center font-semibold shadow-md focus:outline-none rounded-lg cursor-pointer select-none">
                            LOGIN
                            </button>
                        </div>
                    </form>
